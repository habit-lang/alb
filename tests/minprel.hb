...
else     ByteSize (Stored t)      = 1 if BitSize t = 8
else     ByteSize (Stored t)      = 2 if BitSize t = 16
else     ByteSize (Stored t)      = 4 if BitSize t = 32
...
primitive readRef  :: ARef l (Stored t) -> M t
primitive writeRef :: ARef l (Stored t) -> t -> M ()
...
instance ToUnsigned (Bit n) if n < 33 -- doesn't work with Width n
 where unsigned x = Unsigned [ bits = 0 :# x ]   -- needs :#

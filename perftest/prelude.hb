...
primitive primBitdataEquals :: BitSize t n => t -> t -> Bool
...
-- instance NonZero (Bit n) = NZBit n if Width n
...
instance ToUnsigned Unsigned where unsigned u = u
...
class Proc p | Monad p  -- super class required (by specializer)!
